...
public class PlayerController {
    ...
    public ResponseEntity<? extends Object> addPlayer(@RequestBody PlayerRequest request){
        try {
...
//    @GetMapping(path = "/get/{teamName}",produces = "application/json")
    ...
    public ResponseEntity<PlayerEntity> updateUser(@PathVariable int playerId, @RequestBody PlayerRequest request){
        try {
